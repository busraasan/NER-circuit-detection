...
SAVE_ROOT="results/advanced_ner_circuit_dataset_correct_tag/kl_divergence"
...
MODEL_ARG="--model_name gpt2-small"           # e.g., MODEL_ARG="--model_name gemma-2b"
COMPONENT_ARG=${COMPONENT_ARG:-}    # e.g., COMPONENT_ARG="--component z"
